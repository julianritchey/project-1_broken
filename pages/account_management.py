...
# questrade_accounts_data = q.accounts
# questrade_account_balances = q.account_balances(questrade_accounts_data['accounts'][0]['number'])

# print(questrade_account_balances)
# questrade_account_balances = pd.DataFrame(questrade_account_balances)

# questrade_accounts_list = []
# print(questrade_account_balances)
# for i in range(len(questrade_account_balances)):
#     print(questrade_account_balances.iloc[i])
#     l = pd.DataFrame.from_dict(questrade_account_balances.iloc[i]).reset_index()
#     print(l)
#     for j, k in questrade_account_balances.iloc[i].items():
#         #print(j)
#         #print(k)
#         questrade_accounts_list.append(
